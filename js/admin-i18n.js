(() => {
  ...
  const HU = {
    ...
    "properties.confirm_change_client_email": "Ez minden, ehhez az ügyfélhez rendelt ingatlannál megváltoztatja az ügyfél belépési e-mail-címét. Folytatod?",
    ...
    "task.incomplete_confirm": "{count} checklist t\u00e9tel nincs k\u00e9sz. Ennek ellen\u00e9re befejezed a munk\u00e1t? \u00cdrj megjegyz\u00e9st, ha az \u00fcgyf\u00e9lnek tudnia kell az ok\u00e1t.",
    ...
    "timeline.owner_placeholder": "Tulajdonos",
    "timeline.activity_placeholder": "Tev\u00e9kenys\u00e9g",
    "timeline.cleaning": "Takar\u00edt\u00e1s",
  ...
  const STATIC_TEXT_BINDINGS = [
    ...
    ["[data-theme-set='canary']", "header.canary", "Canary Islands"],
  ...
  const LITERAL_PAIRS = [
    ...
    ["Staff", "Munkatars"],
    ["Client", "Ugyfel"],
    ["Client email / login email", "Ügyfél e-mail / belépési e-mail"],
    ["Changes the client's login email for all their properties.", "Az ügyfél összes ingatlanánál megváltoztatja a belépési e-mail-címet."],
    ["Enter a valid client email.", "Adj meg egy érvényes ügyfél e-mail-címet."],
    ["Client account not found.", "Az ügyfélfiók nem található."],
    ["Saving...", "Mentés..."],
    ...
    ["Checklist note", "Checklist megjegyz\u00e9s"],
    ["Save note", "Megjegyz\u00e9s ment\u00e9se"],
    ["Visible to the client.", "Az \u00fcgyf\u00e9l sz\u00e1m\u00e1ra is l\u00e1that\u00f3."],
    ["Explain why an item could not be completed.", "\u00cdrd le, mi\u00e9rt nem lehetett elv\u00e9gezni valamelyik t\u00e9telt."],
    ["Checklist note saved.", "Checklist megjegyz\u00e9s mentve."],
    ["Select a date.", "Valassz datumot."],
    ["Select a property.", "Valassz ingatlant."],
    ["Select an activity type.", "Valassz tevekenysegtipust."],
    ["Select an activity.", "V\u00e1lassz tev\u00e9kenys\u00e9get."],
