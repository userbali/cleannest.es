(() => {
  ...
  const TRANSLATIONS = {
    ...
    hu: {
      ...
      "why.hosts.caption": "Ki és bejelentkezés közti takarítás akár rövid időn belül.",
      "why.hosts.f1h": "Ki és bejelentkezés",
      "why.hosts.f1p": "Professzionális takarítás, hogy ingatlanod készenálljon az új vendég fogadására.",
      "why.hosts.f2h": "Igény esetén host feladatok ellátása",
      "why.hosts.f2p": "Kulcsok átadása, ingatlan bemutatása.",
      "why.hosts.f3h": "Teljes marketing kommunikáció elkészítése",
